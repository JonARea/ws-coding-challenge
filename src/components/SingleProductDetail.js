...
import {
  styleSingleProductDetail,
  styleAddToCart,
  styleSingleProductDetailLeft,
} from '../styles'
    ...
    return (
      <div>
        ...
        <div className="singleProductDetail" style={styleSingleProductDetail}>
          <div className="singleProductDetailLeft" style={styleSingleProductDetailLeft(product)}>
            <img
          ...
          <div className="singleProductDetailRight" style={{maxWidth: '50%'}}>
            ...
            <h3 className="singleProductDetailPrice">
